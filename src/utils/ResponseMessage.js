const ResponseMessage = {
  ...
  REGISTERED_TYPE_NOT_MATCH_FOR_PASSWORD:
    "Register type not match for password",
  ...
  USER_CREATE_SENT_OTP_ON_YOUR_EMAIL:
    "Account has been created. OTP sent to your email address.",
  USER_CREATE_SENT_OTP_ON_YOUR_MOBILE:
    "Account has been created. OTP sent to your mobile number.",
  ALREADY_REGISTER_VERIFY_EMAIL:
    "OTP has been sent to your email. Please verify the OTP to log in",
  ALREADY_REGISTER_VERIFY_MOBILE:
    "OTP has been sent to your mobile number. Please verify the OTP to log in",
  ...
  TRANSACTION_DATA_GET: "Transaction detail fetched successfully",
  ...
  TERMS_ADDED: "Terms and condition submitted successfully",
  TERMS_UPDATED: "Terms and condition submitted successfully",
  ...
  GAME_DEACTIVATE: "Game deactivated successfully",
  ...
  SETTING_NOT_FOUND: "Setting get successfully",
  ...
  TRANSACTION_UPDATED: "Transaction completed successfully",
  TRANSACTION_DELETED: "Transaction deleted successfully",
  TRANSACTION_GET: "Transaction get successfully",
  TRANSACTION_NOT_FOUND: "Transaction not found",
  // WITHDRAWAL_CREATED : "Withdrawal created successfully",
  WITHDRAWAL_CREATED: "Your withdrawal request is send to admin",
  // WITHDRAWAL_UPDATED: "Withdrawal updated successfully",
  WITHDRAWAL_DELETED: "Withdrawal deleted successfully",
  WITHDRAWAL_GET: "Withdrawal get successfully",
  // WITHDRAWAL_NOT_FOUND: "withdrawal not found",
  WITHDRAWAL_REQUEST_ACCEPTED: "Withdrawal request accepted",
  ...
  USER_DISABLE_BY_ADMIN: "Account deactivating successfully",
  ...
  NUMBER_RESULT: "Get number bet result successfully",
  ...
  PERMISSION_ACTIVE: "Permission activated successfully",
  PERMISSION_DEACTIVE: "Permission deactivated successfully",
  SUBADMIN_ALREADY_EXITS: "Already exits subadmin",
  SUBADMIN_NOT_FOUND: "Subadmin not found",
  SUBADMIN_CREATED: "Subadmin created successfully",
  SUBADMIN_GET: "Get subadmin successfully",
  SUBADMIN_DELETED: "Subadmin deleted successfully",
  SUBADMIN_ACTIVE: "Subadmin activated successfully",
  SUBADMIN_DEACTIVATE: "Subadmin deactivated successfully",
  CURRENCY_ALREADY_EXITS: "This currency already exits",
  CURRENCY_COIN_CREATED: "Currency created successfully",
  CURRENCY_COIN_UPDATED: "Currency updated successfully",
  ...
  STATUS_REJECT: "deposit request status reject successfully",
