const ResponseMessage = {
  ...
  REGISTERED_TYPE_NOT_MATCH_FOR_PASSWORD:
    "You have not registered with password ,kindly login with otp then set password.",
  REGISTERED_TYPE_NOT_MATCH_FOR_OTP:
    "You have not registered with otp ,kindly login with password.",
  ...
  GAME_PERIOD_OVER: "Game available soon",
