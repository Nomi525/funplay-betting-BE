import {
    ...
    getPeriodsDetailsForAllGame, getAllGameRecodesGameWise
} from "../index.js"
...
//#region 
commonRoutes.get("/get-periods-details-all-game", Auth, getPeriodsDetailsForAllGame);

//#region Get All Game period records game wise
commonRoutes.get("/get-all-periods-game-wise/:gameType/:gameId", Auth, getAllGameRecodesGameWise);
