...
describe('Color Betting test case', () => {
    ...
    it("Get 2 color betting winner", (done) => {
        chai.request(appServer)
            .get(`/api/user/get-color-betting-winner/2colorBetting/${colorBetDeatils.gameId}/${colorBetDeatils.period}`)
            .set('auth', userToken)
            .end((err, res) => {
                if (res.body.status == 200) {
                    expect(res.body.status).to.be.equal(200);
    ...
    it("Get all 3 color game winners", (done) => {
        chai.request(appServer)
            .get(`/api/user/get-all-color-game-winners/${threeColorBetDeatils.gameId}`)
            .set('auth', userToken)
            .end((err, res) => {
                if (res.body.status == 200) {
                    expect(res.body.status).to.be.equal(200);
    ...
    it("Get Single 3 color Single game winners", (done) => {
        chai.request(appServer)
            .get(`/api/user/get-single-color-game-winners/${threeColorBetDeatils.gameId}`)
            .set('auth', userToken)
            .end((err, res) => {
                if (res.body.status == 200) {
                    expect(res.body.status).to.be.equal(200);
    ...
    it("Get 3 color betting winner", (done) => {
        chai.request(appServer)
            .get(`/api/user/get-color-betting-winner/3colorBetting/${threeColorBetDeatils.gameId}/${threeColorBetDeatils.period}`)
            .set('auth', userToken)
            .end((err, res) => {
                if (res.body.status == 200) {
                    expect(res.body.status).to.be.equal(200);
